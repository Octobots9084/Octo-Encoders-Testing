...
public class RobotTalonfx extends TimedRobot {
    ...
    public void teleopInit() {
        ...
        this.motor1.configStatorCurrentLimit(new StatorCurrentLimitConfiguration(true, 10, 10, 0.05)); //How much current the motor can use (outputwise)
        ...
        this.motor1.configSelectedFeedbackSensor(TalonFXFeedbackDevice.IntegratedSensor,
